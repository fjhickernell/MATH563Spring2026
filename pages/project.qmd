...
- Submit your **project topic** using the course topic-submission form &lt;To Be Announced&gt;  
- After the topic deadline, check the posted **topic list** &lt;To Be Announced&gt;  to confirm approval.
- Prepare a **15-minute oral presentation** (+5 minutes for questions) and a **1–2 page handout** for the audience.
- Also submit a brief **written component** (typical expectation: 4–8 pages, depending on project type), including references.
