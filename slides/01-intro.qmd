...
measure how often $A$ occurs within that restricted universeof $A$ given $B$ (with $\Prob(B)>0$):
$$
\Prob(A \mid B)
=
...
> If you meet an introvert, is she more likely to be a professor or a salesman?
