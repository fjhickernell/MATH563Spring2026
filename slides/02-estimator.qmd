...
subtitle: |
  ...
  <span class="deck-meta">{{< meta course.textbook.short >}} Ch. 5–7 (parts) </span>
...
Although they may be [asymptotically]{.alert} unbiased many MLEs are biased for finie sample size but the bias is computable (see previous slide).  Thus, the bias can be analyzed
