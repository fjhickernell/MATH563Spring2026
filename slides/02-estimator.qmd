...
_Proof that $T(\vX)$ is sufficient_: Suppose that $\ell(\vtheta \mid \vx) - \ell(\vtheta \mid \vy)$ is independent of $\vtheta$ iff $T(\vx) = T(\vy)$
...
_Proof that $T(\vX)$ is minimal sufficient_:  Let $T'(\vX)$ be any other sufficient statistic, so
...
### Example of minimal sufficient but NOT complete
