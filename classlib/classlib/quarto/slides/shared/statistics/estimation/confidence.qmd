...
annotate_xaxis_marks(
    ax,
    [q_ex_lo, q_ex_hi],
    [r"$\overline{X}_{L}^{\text{ex}}$", r"$\overline{X}_{U}^{\text{ex}}$"],
    colors=[curve_color, curve_color],
    tick_height=0.05,
    tick_linewidth=3.0,
    text_offset_pts=-22,
    fontsize=18,
...
annotate_xaxis_marks(
    ax,
    [q_clt_lo, q_clt_hi],
    [r"$\overline{X}_{L}^{\text{clt}}$", r"$\overline{X}_{U}^{\text{clt}}$"],
    colors=[clt_color, clt_color],
    tick_height=0.15,          # negative draws upward
    tick_linewidth=3.0,
    text_offset_pts=-42,          # negative pushes above
    va="bottom",
    fontsize=18,
)
