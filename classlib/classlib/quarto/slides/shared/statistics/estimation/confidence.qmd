...
# tick at 0 with label μ (center of the pivot)
ax.plot([0, 0],
        [0, -0.05],
        transform=ax.get_xaxis_transform(),
        color="black",
...
<a class="button" style="margin-left:0em;" href="{{< meta course_website >}}classlib/classlib/notebooks/confidence_interval_exact_vs_clt_vs_bootstrap.ipynb" download>
⬇ Exact vs CLT vs Bootstrap Confidence Interval Coverage 📓
</a>
