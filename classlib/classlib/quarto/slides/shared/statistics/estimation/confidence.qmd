...
y_left = st.norm.pdf(left)
y_right = st.norm.pdf(right)
ax1.vlines(left, 0, y_left, linestyle="-", linewidth=4, color=tail_color) # Critical value line: ONLY up to the pdf
ax1.vlines(right, 0, y_right, linestyle="-", linewidth=4, color=tail_color) # Critical value line: ONLY up to the pdf
...
y_left = st.norm.pdf(lower)
y_right = st.norm.pdf(upper)
ax1.vlines(lower, 0, y_left, linestyle="-", linewidth=4, color=tail_color) # Critical value line: ONLY up to the pdf
ax1.vlines(upper, 0, y_right, linestyle="-", linewidth=4, color=tail_color) # Critical value line: ONLY up to the pdf
# --- mark lower, μ, upper ---
