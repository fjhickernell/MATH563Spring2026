...
<a class="button" style="margin-left:2em;" href="{{< meta course_website >}}classlib/classlib/notebooks/health_wealth_gapminder_regression.ipynb" download>
⬇ Health vs. Wealth 📓
</a>
:::
...
For $K(t,x) = 2 - \lvert t - x\rvert$ this is the [trapezoidal rule]{.alert}.  <a class="button" style="margin-left:2em;" href="{{< meta course_website >}}classlib/classlib/notebooks/Bayesian_quadrature.ipynb" download>
⬇ Bayesian Quadrature 📓
</a>
</div>
