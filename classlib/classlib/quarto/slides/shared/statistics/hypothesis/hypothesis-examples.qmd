...
ax = plt.gca()
annotate_xaxis_marks(ax, [mu0], [r"$\mu_0$"], colors=["black"], text_offset_pts=-50, fontsize=20)
annotate_yaxis_marks(ax, [alpha], [r"$\alpha$"], colors=["black"], text_offset_pts = -40, fontsize=20)
...
plt.xlabel(r"True standard deviation $\sigma_1$", fontsize=18)
plt.ylabel("Power", fontsize=18)
...
ax = plt.gca()
annotate_xaxis_marks(ax, [sigma0], [r"$\sigma_0$"], colors=["black"], text_offset_pts=-45, fontsize=20)
annotate_yaxis_marks(ax, [alpha],  [r"$\alpha$"],   colors=["black"], text_offset_pts=-35, fontsize=20)
