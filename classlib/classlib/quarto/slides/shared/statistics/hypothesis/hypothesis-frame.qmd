...
flowchart LR
  ...
  subgraph D1["Design Phase (Before Data)"]
    A[Model Assumptions]
    B[Choose Test Statistic]
    C[Sampling Distribution under H0]
    D[Fix Rejection Region (size α)]
  end

  subgraph D2["Data Phase (After Data)"]
    E[Observe Data]
    F[Compute Test Statistic]
    G[Decision: Reject or Not]
  end
