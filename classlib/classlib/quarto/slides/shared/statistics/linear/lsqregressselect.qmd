...
- Large $F$ gives evidence that the extra predictors improve the model  
...
- Use $t$-tests to *identify candidates for removal*, but do not automatically remove them based on a single test
